...
export const Stepper = () => {
  ...
  const steps = [
    {
      href: "/cdd/naicom-partners/company-info",
      label: d.companyInfo,
      success: companyInfoSuccess,
    },
    {
      href: "/cdd/naicom-partners/directors-info",
      label: d.directorsInfo,
      success: directorsInfoSuccess,
    },
    {
      href: "/cdd/naicom-partners/account-details",
      label: d.accountDetails,
      success: accountDetailsSuccess,
    },
    {
      href: "/cdd/naicom-partners/file-uploads",
      label: d.fileUploads,
      success: fileUploadsSuccess,
    },
    {
      href: "/cdd/naicom-partners/review",
      label: d.review,
