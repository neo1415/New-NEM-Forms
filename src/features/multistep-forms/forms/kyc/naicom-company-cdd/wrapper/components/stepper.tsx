...
export const Stepper = () => {
  ...
  const steps = [
    {
      href: "/kyc/naicom-company-cdd/company-info",
      label: d.companyInfo,
      success: companyInfoSuccess,
    },
    {
      href: "/kyc/naicom-company-cdd/directors-info",
      label: d.directorsInfo,
      success: directorsInfoSuccess,
    },
    {
      href: "/kyc/naicom-company-cdd/account-details",
      label: d.accountDetails,
      success: accountDetailsSuccess,
    },
    {
      href: "/kyc/naicom-company-cdd/file-uploads",
      label: d.fileUploads,
      success: fileUploadsSuccess,
    },
    {
      href: "/kyc/naicom-company-cdd/review",
      label: d.review,
