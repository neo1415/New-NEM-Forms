...
export const Stepper = () => {
  ...
  const steps = [
    {
      href: "/kyc/partners-cdd/company-info",
      label: d.companyInfo,
      success: companyInfoSuccess,
    },
    {
      href: "/kyc/partners-cdd/directors-info",
      label: d.directorsInfo,
      success: directorsInfoSuccess,
    },
    {
      href: "/kyc/partners-cdd/account-details",
      label: d.accountDetails,
      success: accountDetailsSuccess,
    },
    {
      href: "/kyc/partners-cdd/file-uploads",
      label: d.fileUploads,
      success: fileUploadsSuccess,
    },
    {
      href: "/kyc/partners-cdd/review",
      label: d.review,
