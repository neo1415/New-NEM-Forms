...
import { EducationalInstitutions } from "@/features/multistep-forms/forms/claims/motor/history/components/educational-institutions";
import { PreviousEmployers } from "@/features/multistep-forms/forms/claims/motor/history/components/previous-employers";
import {
  useDegrees,
  useEmploymentStatuses,
  useReasonsForLeaving,
} from "@/features/multistep-forms/forms/claims/motor/history/hooks/useQueries";
import { useStore } from "@/features/multistep-forms/forms/claims/motor/history/hooks/useStore";
import {
  defaultValues,
  ReasonForLeavingEnum,
  schema,
  Schema,
} from "@/features/multistep-forms/forms/claims/motor/history/types/schema";
