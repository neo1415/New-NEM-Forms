...
import { useProficiencyLevels } from "@/features/multistep-forms/forms/claims/motor/skills/hooks/useQueries";

import { Schema } from "@/features/multistep-forms/forms/claims/motor/skills/types/schema";
